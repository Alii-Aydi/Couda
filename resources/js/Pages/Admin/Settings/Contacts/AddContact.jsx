...
const AddContact = ({ auth }) => {
    ...
    return (
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="py-12">
                <h1 className='p-4 text-4xl'>Ajouter Contact</h1>
                <div className="p-7 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Link href={`/dashboard/settings/infra`} className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium text-white ml-2 rounded-3xl bg-red-500 bg:text-red-700 dark:bg-red-600 dark:bg:text-red-800">
                            Cancel
                        </Link>
                    </form>
                </div>
