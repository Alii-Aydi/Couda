...
const Register = ({ roles, auth }) => {
    ...
    const [profilePic, setProfilePic] = useState("/imgs/avatar.png"); // Default profile picture
    ...
    const handleProfilePicChange = (e) => {
        ...
        reader.onloadend = () => {
            ...
            setData('profile_pic', file); // Update profile_pic field in form data
        };
        if (file) {
            ...
            <div className="py-12">
                ...
                <div className="p-7 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg flex justify-center align-content-center">
                    <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-xlg">
                        ...
                        {errors && <div className="text-red-500 text-sm">{errors.profile_pic}</div>}
                        <div>
                        ...
                        <div>
                            ...
                            {errors && <div className="text-red-500 text-sm">{errors.cin}</div>}
                        </div>
                        <div>
